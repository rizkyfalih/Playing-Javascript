...
function driversLicense5(passedTest){
    if(passedTest){
        ...
        console.log(firstName + ' born in ' + yearOfBirth + ' is now allowd to drive a car.');
    }
}
...
var box5 = {
    ...
    clickMe: function() {
        ...
        document.querySelector('.green').addEventListener('click', function() {
            var str = 'This is box number ' + self.posisition + ' and it is ' + self.color;
            alert(str);
        });
    }
}
...
var box6 = {
    ...
    clickMe: function() {
        document.querySelector('.green').addEventListener('click', () => {
            var str = 'This is box number ' + this.posisition + ' and it is ' + this.color;
            alert(str);
        });
    }
}
...
//isFullAge5(1990, 1999, 1965, 2016, 1897);
...
//////////////////////////////////////////////////
// Lecture: Clasess and SubClasses
